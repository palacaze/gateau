...
set(COMPILER_THREAD_IMPL posix)

# which compilers to use for C and C++
find_program(CMAKE_RC_COMPILER NAMES ${COMPILER_PREFIX}-windres)
find_program(CMAKE_C_COMPILER NAMES ${COMPILER_PREFIX}-gcc-${COMPILER_THREAD_IMPL})
find_program(CMAKE_CXX_COMPILER NAMES ${COMPILER_PREFIX}-g++-${COMPILER_THREAD_IMPL})
